  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-amber-50 to-orange-100 p-0 sm:p-5">
      ...
      >
        ...
        {currentPage !== 0 && (
          <>
            <span className="pointer-events-none absolute left-[7%] top-[8%] text-sm text-rose-300/70">&hearts;</span>
            <span className="pointer-events-none absolute right-[14%] top-[12%] text-base text-orange-300/70">&hearts;</span>
            <span className="pointer-events-none absolute bottom-[14%] left-[5%] text-xs text-rose-300/70">&hearts;</span>
            <span className="pointer-events-none absolute bottom-[10%] right-[8%] text-xs text-orange-300/70">&hearts;</span>
          </>
        )}
              ...
              <div className="absolute inset-0 -z-10 flex items-center justify-center bg-gradient-to-br from-orange-100 to-orange-200 p-8 text-center text-orange-800">
                <div>
                  ...
                  <div className="text-sm opacity-70">
                    （封面圖待上傳：
                    <br />
                    public/images/welcome/cover.png）
                  </div>
                </div>
              </div>
            </div>
